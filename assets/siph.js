...
function getCrimes (lat, lng){
   //var baseUrl = "https://api.spotcrime.com/crimes.json?lat=42.3314&lon=-83.0458&radius=0.08&callback=jQuery21306930704791620661_1494546905160&key=privatekeyforspotcrimepublicusers-commercialuse-877.410.1607&_=1494546905164"

  baseUrl = "https://api.spotcrime.com/crimes.json?lat=" + lat + "&lon="+ lng +"&radius=0.08&callback=jQuery21306930704791620661_1494546905160&key=privatekeyforspotcrimepublicusers-commercialuse-877.410.1607&_=1494546905164"
  $.ajax({
    url: baseUrl,
    method: "GET",
    dataType:'jsonp'
...
//function that is the backbone of the actual map on the page 
//takes the google iformation and places it into the HTML 
      function initMap() {
        //access the id 'map' from the HTML
        map = new google.maps.Map(document.getElementById('map'), {
          //giving the map a starting latitude and longitude 
